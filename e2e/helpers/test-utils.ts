 ...
 */
export function createTestImage(width = 100, height = 100, color = 'red'): string {
  // Create a simple canvas and convert to data URL
  const canvas = `<canvas width="${width}" height="${height}"></canvas>`;
